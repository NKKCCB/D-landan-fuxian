...
pretrained_bert_fold = "/data1/hhc/models/bert-base-chinese"
...
if __name__ == "__main__":
    ...
    for i in range(len(file_list)):
        ...
        with open('/data1/hhc/datasets/CAIL2018/CAILsmall/{}_cs.json'.format(file_list[i]), 'r', encoding='utf-8') as f:
            idx = 0
            for line in tqdm(f.readlines(), ncols=80):
                ...
                attention_mask = np.array(inputs['attention_mask'], dtype=float)
        ...
        attention_mask = np.array(attention_mask_lists, dtype=float)
        print(attention_mask.shape)
        ...
        pkl.dump(data_dict, open('/data1/hhc/datasets/processed_dataset/CAIL_new/full_doc/small/{}_bert_chinese.pkl'.format(file_list[i]), 'wb'))
        print(num)
        print(min_count)
